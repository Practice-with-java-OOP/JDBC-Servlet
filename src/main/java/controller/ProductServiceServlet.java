...
public class ProductServiceServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            ...
            case "delete":
                ...
                break;
            case "view":
                detailInformationProduct(request, response);
                break;
            case "search":
                showFormSearchByName(request, response);
                break;
            default:
    ...
    private void showFormSearchByName(HttpServletRequest request, HttpServletResponse response) {
    ...
    private void detailInformationProduct(HttpServletRequest request, HttpServletResponse response) {
        int id = Integer.parseInt(request.getParameter("id"));
        try {
            Product product = this.productService.findById(id);
            RequestDispatcher dispatcher;
